...
implements ITransformer {
    ...
    public void transform(ClassNode classNode, String name) {
        block0: for (MethodNode methodNode : classNode.methods) {
            if (!TransformerMethod.ungrabMouseCursor.matches(methodNode)) continue;
            ...
            while (iterator.hasNext()) {
                ...
                if (!methodInsnNode.owner.equals("org/lwjgl/input/Mouse") || !methodInsnNode.name.equals("setCursorPosition")) continue;
                methodNode.instructions.insertBefore(abstractNode, (AbstractInsnNode)new MethodInsnNode(184, "codes/biscuit/skyblockaddons/asm/hooks/MouseHelperHook", "ungrabMouseCursor", "(II)V", false));
                iterator.remove();
                break block0;
            }
            break block0;
