...
public enum SlayerDrop {
    REVENANT_FLESH(Items.field_151078_bh, "Revenant Flesh", "REVENANT_FLESH", ItemRarity.UNCOMMON, true),
    FOUL_FLESH(Items.field_151044_h, 1, "Foul Flesh", "FOUL_FLESH", ItemRarity.RARE),
    ...
    SCYTHE_BLADE(Items.field_151045_i, "Scythe Blade", "SCYTHE_BLADE", ItemRarity.LEGENDARY, true),
    ...
    TARANTULA_WEB(Items.field_151007_F, "Tarantula Web", "TARANTULA_WEB", ItemRarity.UNCOMMON, true),
    TOXIC_ARROW_POISON(Items.field_151100_aR, 10, "Toxic Arrow Poison", "TOXIC_ARROW_POISON", ItemRarity.RARE),
    ...
    FLY_SWATTER(Items.field_151011_C, "Fly Swatter", "FLY_SWATTER", ItemRarity.EPIC, true),
    ...
    DIGESTED_MOSQUITO(Items.field_151078_bh, "Digested Mosquito", "DIGESTED_MOSQUITO", ItemRarity.LEGENDARY),
    WOLF_TOOTH(Items.field_151073_bk, "Wolf Tooth", "WOLF_TOOTH", ItemRarity.UNCOMMON, true),
    HAMSTER_WHEEL(Item.func_150898_a((Block)Blocks.field_150415_aT), "Hamster Wheel", "HAMSTER_WHEEL", ItemRarity.RARE, true),
    ...
    GRIZZLY_BAIT(Items.field_151115_aP, 1, "Grizzly Bait", "GRIZZLY_BAIT", ItemRarity.RARE),
    RED_CLAW_EGG(Items.field_151063_bx, 96, "Red Claw Egg", "RED_CLAW_EGG", ItemRarity.EPIC),
    OVERFLUX_CAPACITOR(Items.field_151128_bU, "Overflux Capacitor", "OVERFLUX_CAPACITOR", ItemRarity.EPIC),
    ...
    NULL_SPHERE(Items.field_151154_bQ, "Null Sphere", "NULL_SPHERE", ItemRarity.UNCOMMON, true),
    TWILIGHT_ARROW_POISON(Items.field_151100_aR, 5, "Twilight Arrow Poison", "TWILIGHT_ARROW_POISON", ItemRarity.UNCOMMON),
    ...
    NULL_ATOM(Item.func_150898_a((Block)Blocks.field_150471_bO), "Null Atom", "NULL_ATOM", ItemRarity.RARE, true),
    ...
    private static final HashMap<String, String> internalItemTranslations;

    private SlayerDrop(Item item, String name, String skyblockID, ItemRarity rarity) {
        this(item, name, skyblockID, rarity, false);
    }

    private SlayerDrop(String name, String skyblockID, ItemRarity rarity, String enchantID, int enchantLevel) {
        this.itemStack = ItemUtils.createEnchantedBook(name, skyblockID, enchantID, enchantLevel);
        this.skyblockID = skyblockID;
        this.rarity = rarity;
    }

    private SlayerDrop(Item item, String name, String skyblockID, ItemRarity rarity, boolean enchanted) {
        this(item, 0, name, skyblockID, rarity, enchanted);
    }

    private SlayerDrop(Item item, int meta, String name, String skyblockID, ItemRarity rarity) {
        this(item, meta, name, skyblockID, rarity, false);
    }

    private SlayerDrop(Item item, int meta, String name, String skyblockID, ItemRarity rarity, boolean enchanted) {
        this.itemStack = ItemUtils.createItemStack(item, meta, name, skyblockID, enchanted);
        this.skyblockID = skyblockID;
        this.rarity = rarity;
    }

    private SlayerDrop(String name, String skyblockID, ItemRarity rarity, String skullID, String textureURL) {
        this.itemStack = ItemUtils.createSkullItemStack(name, skyblockID, skullID, textureURL);
        this.skyblockID = skyblockID;
        this.rarity = rarity;
    }

    private SlayerDrop(String name, String skyblockID, String runeID, ItemRarity rarity, String skullID, String textureURL) {
    ...
    static {
        internalItemTranslations = new HashMap();
